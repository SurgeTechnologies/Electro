...
namespace Electro
{
    ...
    public:
        ...
        virtual bool operator ==(const Texture& other) const override { return mSRV == ((DX11Texture2D&)other).mSRV; }
    private:
    ...
    public:
        ...
        virtual void SetData(void* data, Uint size) override {}
        virtual void Unbind() const override {}
        virtual bool operator ==(const Texture& other) const override { return mSRV == ((DX11TextureCube&)other).mSRV; }
    private:
